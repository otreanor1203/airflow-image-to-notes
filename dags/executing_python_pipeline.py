...
def read_csv_file():
    df = pd.read_csv('/home/owen/airflow/datasets/insurance.csv')
...
def groupby_smoker(ti):
    ...
    smoker_df.to_csv(
        '/home/owen/airflow/output/grouped_by_smoker.csv', index=False)
...
def groupby_region(ti):
    ...
    region_df.to_csv(
        '/home/owen/airflow/output/grouped_by_region.csv', index=False)
